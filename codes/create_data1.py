...
if __name__ == '__main__':
    get_data_list(audio_path='E:/光纤大创训练/10月csdn借鉴/AudioClassification-Pytorch/dataset/数据处理结果/内光纤/分类后文件', 
                  list_path='E:/光纤大创训练/10月csdn借鉴/AudioClassification-Pytorch/dataset/数据处理结果/内光纤/分类后文件')
